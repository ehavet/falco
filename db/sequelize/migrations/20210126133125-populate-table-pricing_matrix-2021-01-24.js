...
module.exports = {
  up: async (queryInterface) => {
    ...
    const csvFileName = 'pricing-matrix_2021-01-24.csv'
    const tableAndFieldsToPopulate = 'pricing_matrix(id,partner,cover,room_count,pricing_zone,cover_monthly_price,cover_monthly_price_excl_tax,cover_monthly_price_tax)'
