export const expectedValidationEmailMessage: string = '<!DOCTYPE html>\n' +
    ...
    'http://front-url/validate?token=3NCRYPT3DB4%2BS364STR1NG%3D%3D" style="background: #2C2B94; border: 1px solid #2C2B94; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 24px;">Valider mon adresse email</a>\n' +
    '\t\t\t\t\t\t\t\t\t\t\t</td>\n' +
    '                                        </tr>\n' +
    '                                    </table>\n' +
    '                                    <!-- Button : END -->\n' +
    ...
    '                                                  <a class="button-a button-a-primary" href="\n' +
    'http://front-url/validate?token=3NCRYPT3DB4%2BS364STR1NG%3D%3D" style="background: #8180BF; border: 1px solid #8180BF; font-family: sans-serif; font-size: 15px; line-height: 15px; text-decoration: none; padding: 13px 17px; color: #ffffff; display: block; border-radius: 24px;">Confirm my email address</a>\n' +
    '                                             </td>\n' +
    '                                         </tr>\n' +
    '                                     </table>\n' +
    '                                     <!-- Button : END -->\n' +
