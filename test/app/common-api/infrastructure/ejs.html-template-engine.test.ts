import { EjsHtmlTemplateEngine } from '../../../../src/app/common-api/infrastructure/ejs.html-template-engine'
import { HtmlTemplateEngineConfig } from '../../../../src/configs/html-template-engine.config'
import { expect } from '../../../test-utils'
import { HtmlTemplateEngine, HtmlTemplateEngineFileNotFoundError } from '../../../../src/app/common-api/domain/html-template-engine'
