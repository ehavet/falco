...
function _buildSubscriptionValidationMessage (): string {
  const html = '<!DOCTYPE html>\n' +
      ...
      '                        <img src="https://assurance.appenin.fr/assets/header-congratulations.png" width="600" height="" alt="alt_text" border="0" style="width: 100%; max-width: 600px; height: auto; background: #000000; font-family: sans-serif; font-size: 15px; line-height: 15px; color: #555555; margin: auto; display: block;" class="g-img">\n' +
      '                    </td>\n' +
      '                </tr>\n' +
